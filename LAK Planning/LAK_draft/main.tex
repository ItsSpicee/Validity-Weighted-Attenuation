...
\auth{SHAP values \cite{LundbergLee2017} on held-out professors, grouped into eight polarity $\times$ topic categories, show broadly coherent directional patterns: higher positive-emotion feature values generally contribute positively to predicted ratings, while higher negative-emotion feature values generally contribute negatively. At lower feature values, these contribution patterns can reverse (Figure~\ref{fig:baseline-shap}).}
