...
Existing computational SET research describes sentiment and topics but offers few mechanisms connecting an explicit relevance taxonomy to model-estimated rating adjustments. We introduce \textbf{validity-informed attenuation}, an ABSA method that attenuates the modelled contribution of \emph{taxonomy-excluded affect}: affect expressed in clauses assigned outside the stated taxonomy. Exclusion does not imply that the content is unimportant or invalid. The method makes rating sensitivity to the taxonomy auditable by preserving original reviews alongside classifications, emotion features, density values, and adjustment records. This supports a proposed human-review workflow where important criteria cannot be fully specified \cite{DoshiVelez2017} and analytics must connect to pedagogical interpretation and action \cite{GasevicDawsonSiemens2015}. Such inspectability addresses concerns about black-box systems in SET \cite{Rybinski2021,Zhuang2025}.
...
Research on computational estimation of comment relevance shows that filtering by pedagogical value can improve prediction accuracy \cite{Sorour2015,Louis2013,Xiong2011}. Neither line of work specifies how pedagogical relevance should modulate affect's contribution to rating interpretation.
...
density estimates and adjustments. In future theoretical formal applications, stakeholders could
...
The remaining gap is an explicit rating-adjustment mechanism whose outputs are auditable and contestable \cite{DrachslerGreller2016}, supporting pedagogical interpretation and action \cite{GasevicDawsonSiemens2015}.
%========================================================================================
\section{Method}
%========================================================================================
...
Table~\ref{tab:discordant} shows how attenuation adds information about fitted-model sensitivity to content density. In Pair 1, similar densities accompany substantially different adjustment magnitudes, and attenuation alone matches the unanimous expert judgment. In Pair 6, the higher-density review receives the smaller adjustment, and density alone matches the unanimous judgment.
...
inspect and question the basis of any adjustment. As a proof of concept, validity-informed attenuation makes rating sensitivity to a stated relevance taxonomy explicit and auditable, providing a mechanism, an evaluation protocol, and a density-only baseline for future teaching-feedback analytics.
%----------------------------------------------------------------------------------------
\phantomsection
